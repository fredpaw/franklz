...
if(!function_exists('avia_logo'))
{
	 ...
	 */
	function avia_logo($use_image = "", $sub = "", $headline_type = "h1", $dimension = "", $second_image = "")
	{
		...
		if($logo = avia_get_option('logo'))
		{
			 ...
			 $logo = "<$headline_type class='logo'><a href='".$link."'>".$logo."$sub</a><img id='weixin_dr' src='".$second_image."'/></$headline_type>";
		}
		else
		{
