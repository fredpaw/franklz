...
<p class='entry-content'><strong class="no_found"><?php _e('Nothing Found', 'avia_framework'); ?></strong><br/>
<br/>
...
<section class="404_recommendation">
	...
	<p class="return_home"><a href="<?php echo home_url(); ?>">返回首页</a></p>
    <div class='hr_invisible'></div>

<!--    <h3 class='error_sub'><?php _e('Feel like browsing some posts instead?', 'avia_framework'); ?></h3>
